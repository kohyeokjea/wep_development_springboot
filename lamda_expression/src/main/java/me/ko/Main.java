...
/*
    ...
    4. 람다식 장단점
        장점 :
            ...
            3. 함수형 프로그래밍 지원 : Java에서 객체지향에서 벗어나 함수형 프로그래밍을 구현할 수 있는 도구를 제공
            4. 코드 유지 보수성 : '간단한 동작을 위한 코드'는 수정 및 유지 보수가 쉬움

        단점 :
            1. 복잡한 로직 구현의 어려움 : 긴 메서드를 구현하는 경우에 비효율적
            2. 디버깅의 어려움 : 익명 클래스에 비해 디버깅이 어렵다.
                -> 오류 상황에서 람다식의 위치 파악이 어려움.
            3. 함수형 인터페이스 제한 : 함수형 인터페이스를 기반으로 동작하기 때문에 모든 경우에 사용할 수 있는 것이 아님
 */
public class Main {
