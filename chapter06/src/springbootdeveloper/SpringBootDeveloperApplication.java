...
/*
    ...
    1. 데이터베이스(database)란?
        ...
        DBMS(DataBase Management System) : 기본적으로 데이터베이스는 많은 사람이 공유할 수 있어야 하고,
            ...
            관계형 DBMS
                ...
                관련된 값들이 들어감(Java를 기준으로는 User 클래스의 인스턴스를 떠올리면 된다.)
            ...
            H2, MySQL
                ...
                H2 - 자바로 작성되어 있는 RDBMS: 스프링 부트가 지원하는 인메모리 관계형 데이터베이스
                    ...
                    실제 서비스에서는 사용하지 않습니다.
                MySQL - 실제 서비스로 올릴 때 사용할 RDBMS -> 추후 공부
    ...
    2. ORM이란?
        Object-Relational Mapping이라고 하며 자바의 객체와 데이터베이스를 연결하는 프로그래밍 기법
            ...
            SQL을 이용하여 데이터를 꺼내 사용하지만, ORM이 있담녀 데이터베이스의 값을 마치 객체처럼 사용할 수 있음.
            즉, SQL에 여려움을 겪는다고 하더라도 자바 언어로만 데이터베이스에 접근해서 원하는 데이터를 받아올 수 있는 방식.
            즉, 객체와 데이터베이스를 연겨해 자바 언어로만 데이터베이스를 다룰 수 있도록 하는 도구를 ORM이라고 함.
        ...
        장점 :
            ...
            4) 매핑하는 정보가 명확하기 때문에(DB 값과 인스터스 변수의 값), ERD에 대한 의존도를 낮출 수 있고 유지보수시 유리
    ...
    스프링 데이터 JPA에서 제공하는 메서드 사용
        MemberRepository.java 파일에서 create test 함.
 */
