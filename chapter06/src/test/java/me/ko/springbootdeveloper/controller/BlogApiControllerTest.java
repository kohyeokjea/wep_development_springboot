...
class BlogApiControllerTest {
    ...
    public void updateArticle() throws Exception {
        ...
        final String newContnet = "새 내용";

        UpdateArticleRequest request = new UpdateArticleRequest(newTitle, newContnet);
        ...
        assertThat(article.getContent()).isEqualTo(newContnet);
    }
