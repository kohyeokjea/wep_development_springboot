...
/*
     New project 생성시 주의점:
        ...
        2. DLS -> Groovy 설정
        3. name = ArtifactId
        4. build.gradle 설정을 복사하는데, 복사 후에 -> sync를 꼭꼬 눌러주셔야 합니다.
            -> SpringBootDeveloperApplication에서 @SpringBootApplication 애너테이션에 빨간줄이 있다면 새로고침 안했을 확률이 거의 90%
        5. resources 내에 static 내에 index.html이라고 하는데, 해당 폴더명의 경우 대부분의 개발자들이 합의한 형태
        6. 앞으로의 수업 시간에는 new project 생성시에 이렇게 자세히 풀이할 일은 자주 있지 않을 예정이니 꼭 익혁주시기 바람
            -> github 본다고 되는부분이 아니니만큼 신경써야 한다.
 */
